...
(function () {
    ...
    var BLOG_TOPICS = [
        { id: 'b1', topics: ['choose seo', 'right seo', 'which seo', 'seo service for my business', 'seo for my business', 'seo service', 'seo agency'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'This guide matches the right type of SEO to your business stage, budget and goals — plus the questions to ask before you commit.', links: [{ label: '📖 Read the article', href: '/blog/how-to-choose-seo-service.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['💰 SEO prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b2', topics: ['keyword research', 'keyword', 'keywords', 'search intent', 'long tail', 'long tail keywords', 'keyword difficulty'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'This covers seed keywords, long-tail expansion, search intent, difficulty assessment and mapping — the foundation every other SEO task stands on.', links: [{ label: '📖 Read the article', href: '/blog/what-is-keyword-research.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['💰 SEO prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b3', topics: ['serp', 'serp analysis', 'search results', 'result analysis'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'How studying the search results before creating anything builds a smarter SEO strategy — and stops you targeting keywords you cannot win.', links: [{ label: '📖 Read the article', href: '/blog/serp-analysis-seo-strategy.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['💰 SEO prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b4', topics: ['on-page', 'onpage', 'on page seo', 'seo checklist', 'meta description', 'internal links'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'A practical on-page SEO checklist for small business websites — titles, meta, headings, internal links, URLs and images.', links: [{ label: '📖 Read the article', href: '/blog/on-page-seo-checklist-small-business.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['💰 SEO prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b5', topics: ['technical seo', 'technical', 'crawl', 'indexing', 'indexation', 'core web vitals', 'sitemap', 'robots'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'Crawlability, indexation, sitemaps, page speed and Core Web Vitals — the technical foundations every new website needs.', links: [{ label: '📖 Read the article', href: '/blog/technical-seo-basics-new-websites.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['💰 SEO prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b6', topics: ['seo friendly', 'seo-friendly', 'seo essentials', 'seo tips', 'seo guide', 'make my website seo'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: '12 essentials that make a website SEO-friendly — from structure and speed to content and mobile usability.', links: [{ label: '📖 Read the article', href: '/blog/seo-friendly-website-essentials.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['💰 SEO prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b7', topics: ['search visibility', 'visibility', 'rank higher', 'improve visibility', 'improve ranking', 'improve seo', 'rank my website', 'search ranking'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'A step-by-step path to improving your website\u2019s search visibility — foundations first, then content and authority.', links: [{ label: '📖 Read the article', href: '/blog/improve-website-search-visibility.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['💰 SEO prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b8', topics: ['seo vs', 'vs google ads', 'seo or google ads', 'google ads vs seo', 'organic vs paid', 'organic or paid'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'An honest comparison of SEO vs Google Ads — when organic wins, when paid wins, and how to combine both for growth.', links: [{ label: '📖 Read the article', href: '/blog/seo-vs-google-ads.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['📢 Ads prices', '🔍 SEO prices', '📞 Contact me'] } },
        { id: 'b9', topics: ['google ads vs meta', 'meta vs google', 'facebook vs google', 'which ads platform', 'ads platform'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'Google Ads vs Meta Ads — choosing the right platform for your goals, audience and offer.', links: [{ label: '📖 Read the article', href: '/blog/google-ads-vs-meta-ads.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['📢 Ads prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b10', topics: ['retargeting', 'remarketing', 'retarget'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'How retargeting turns the visitors who left without buying into customers — with audience segments and offers.', links: [{ label: '📖 Read the article', href: '/blog/power-of-retargeting.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['📢 Ads prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b11', topics: ['b2b leads', 'generate b2b', 'b2b lead generation', 'b2b framework', 'b2b lead'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'A practical framework for generating B2B leads — targeting, messaging, channels and follow-up.', links: [{ label: '📖 Read the article', href: '/blog/how-to-generate-b2b-leads.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['👥 Lead gen prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b12', topics: ['lead list', 'build a lead list', 'targeted lead list', 'lead list for sales'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'How to build a targeted, verified lead list for sales and ads — ICP, research, verification and cleaning.', links: [{ label: '📖 Read the article', href: '/blog/build-targeted-lead-list.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['👥 Lead gen prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b13', topics: ['business website', 'professional website', 'website that builds trust', 'website trust'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'How to create a professional business website that builds trust — design, copy, speed and clear calls to action.', links: [{ label: '📖 Read the article', href: '/blog/professional-business-website-trust.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['💰 Website prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b14', topics: ['html vs wordpress', 'wordpress vs html', 'html or wordpress', 'wordpress or html', 'custom vs wordpress'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'An honest HTML vs WordPress comparison for business websites — performance, security, SEO and who maintains it.', links: [{ label: '📖 Read the article', href: '/blog/html-vs-wordpress.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['💰 Website prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b15', topics: ['responsive design', 'responsive', 'mobile friendly', 'mobile-friendly', 'mobile design'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'Why responsive web design matters for SEO and conversions — and what mobile-first actually requires.', links: [{ label: '📖 Read the article', href: '/blog/responsive-web-design-seo.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['💰 Website prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b16', topics: ['landing pages', 'converting landing', 'landing page design', 'design a landing page'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'The principles that make landing pages convert — one goal, clear hierarchy, strong proof and fast load.', links: [{ label: '📖 Read the article', href: '/blog/high-converting-landing-pages.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['💰 Website prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b17', topics: ['website speed', 'page speed', 'site speed', 'slow website', 'load speed'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'How website speed affects user experience and SEO — and where the biggest wins usually hide.', links: [{ label: '📖 Read the article', href: '/blog/website-speed-seo.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['💰 Website prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b18', topics: ['image optimization', 'optimize images', 'image seo', 'compress images', 'image alt'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'How to optimize images for SEO and faster pages — formats, compression, dimensions and alt text.', links: [{ label: '📖 Read the article', href: '/blog/image-seo-optimization.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['💰 Website prices', '🛠️ Services', '📞 Contact me'] } },
        { id: 'b19', topics: ['start with digital marketing', 'digital marketing for small business', 'small business digital marketing', 'begin digital marketing', 'digital marketing for beginners'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'A step-by-step way for small businesses to start with digital marketing without wasting budget.', links: [{ label: '📖 Read the article', href: '/blog/small-business-digital-marketing.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['🛠️ Services', '💰 Prices', '📞 Contact me'] } },
        { id: 'b20', topics: ['social media for small business', 'social media marketing for small', 'start social media', 'social media strategy', 'social media marketing'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'Where small businesses should actually start with social media marketing — channel choice and content rhythm.', links: [{ label: '📖 Read the article', href: '/blog/social-media-marketing-small-business.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['🛠️ Services', '💰 Prices', '📞 Contact me'] } },
        { id: 'b21', topics: ['freelance portfolio', 'portfolio that wins clients', 'freelancer portfolio', 'build a portfolio', 'portfolio website'], any: INFO_WORDS, weight: 7, blog: true,
          answer: { text: 'How to build a professional freelance portfolio that wins clients — projects, proof and presentation.', links: [{ label: '📖 Read the article', href: '/blog/freelance-portfolio-guide.html' }, { label: '📰 All articles', href: PAGE.blog }, { label: '💬 WhatsApp me', href: CONTACT.whatsapp, wa: true }], chips: ['👀 Portfolio', '🛠️ Services', '📞 Contact me'] } }
    ];
